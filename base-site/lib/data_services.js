...
export async function createProduct({ name, price, description, category, quantity }) {
    const { data, error } = await supabase
        .from('products')
        .insert([{
            name,
...
export async function updateProduct(id, { name, price, description, category, quantity }) {
    const { data, error } = await supabase
        .from('products')
        .update({
            name,
